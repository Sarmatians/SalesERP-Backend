...
function customFileStorage(destination) {
...
let UploadController = class UploadController {
    async uploadItemImages(files) {
        const urls = files.images?.map(file => `/item-images/${file.filename}`) || [];
        return { images: urls };
    }
    async uploadItemVariationImages(files) {
...
], UploadController.prototype, "uploadItemImages", null);
__decorate([
    (0, common_1.Post)('item-variation'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileFieldsInterceptor)([{ name: 'images', maxCount: 10 }], {
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UploadController.prototype, "uploadItemVariationImages", null);
